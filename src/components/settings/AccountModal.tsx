            ...
            <div className="rounded-lg border border-border p-3 space-y-2">
              ...
              <div className="space-y-1.5">
                ...
                <div className="flex items-center justify-between text-xs">
                  ...
                  <span className={`text-[0.65rem] font-medium ${info.providers.includes("google") ? "text-emerald-500" : "text-muted-foreground/40"}`}>
                ...
                <div className="flex items-center justify-between text-xs">
                  ...
                  <span className={`text-[0.65rem] font-medium ${info.providers.includes("github") ? "text-emerald-500" : "text-muted-foreground/40"}`}>
