    ...
    <div className="flex min-h-screen items-center justify-center bg-gradient-to-br from-violet-500/10 via-background to-cyan-500/5 dark:from-violet-500/15 dark:via-background dark:to-cyan-500/8 px-4">
      ...
      >
          ...
          <div className="space-y-1.5">
            ...
            <div className="relative">
              <input
                ...
                className="w-full rounded-md border bg-card/50 dark:bg-white/5 backdrop-blur-sm border-border/50 dark:border-white/[0.08] focus:border-primary/50 focus:ring-2 focus:ring-primary/20 focus:shadow-[0_0_12px_oklch(0.72_0.25_285_/_15%)] px-3 py-2 pr-10 text-sm outline-none transition-all"
              />
              <button
                type="button"
        ...
        <p className="text-sm text-muted-foreground">
          ...
          <Link href="/signin" className="bg-gradient-to-r from-violet-400 to-cyan-400 bg-clip-text text-transparent hover:underline">
            Sign in
          </Link>
        </p>
