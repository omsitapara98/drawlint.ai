...
export const metadata = {
  title: "System Design Library — Examples & AI Reviews | DrawLint.ai",
  description:
    "Browse real system design solutions from the community — each diagram reviewed by 6 specialized AI reviewers with a hire/no-hire signal. Free to explore.",
